...
public class LiveTemplate {
    static final Map<String, String> ENTITIES = Map.of(
            "&", "&amp;",
            "<", "&lt;",
            ">","&gt;",
            "\"", "&quot;",
    ...
    static final String escapeStringHTML(String input) {
        ...
        return m.replaceAll((replacer) -> {
            ...
            return ENTITIES.get(replacer.group().toString());
        });
    };
    ...
    public Map<String, Object> toParts() {
        var indexedValues = IntStream.range(0, this.raw.values().size())
                .mapToObj(i -> {
